...
class GameController {
    ...
    static getSessions(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const sessions = yield game_repositories_1.GameRepository.fetchGameSessions(Number(page), Number(limit));
     ...
     *               $ref: '#/components/schemas/Error'
     */
    static getSessionDetails(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                const session = yield game_repositories_1.GameRepository.findSessionById(id);
                if (!session) {
     ...
     *               $ref: '#/components/schemas/Error'
     */
    static getSessionHistory(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                const history = yield game_repositories_1.GameRepository.fetchHistoryForSession(id);
    ...
    static getUserHistory(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const history = yield game_repositories_1.GameRepository.fetchUserGameHistory(userId);
                return res.status(200).json(history);
            }
            catch (error) {
    ...
    /**
      ...
      *         description: Internal Server Error.
      */
    static getUserPerformanceInSession(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (cachedData) {
                    ...
                    const fullResults = JSON.parse(cachedData);
                ...
                const user = yield User_1.UserModel.findById(userId).select('name');
                if (!user) {
                    return res.status(404).json({ message: 'User not found.' });
                }
                const performanceDetails = yield game_repositories_1.GameRepository.fetchUserPerformanceInSession(userId, sessionId);
     ...
     *               $ref: '#/components/schemas/Error'
     */
    static addFeedbackToSession(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { sessionId } = req.params;
                // Manual validation is no longer needed
                const { rating, comment } = req.body;
                const result = yield game_repositories_1.GameRepository.addFeedback(sessionId, rating, comment);
   ...
   */
    /**
       ...
       *         description: Internal Server Error.
       */
    static getSessionResults(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { sessionId } = req.params;
                const { userId, guestName, view } = req.query;
     ...
     *         description: Internal Server Error.
     */
    static getGuestPerformanceInSession(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { sessionId } = req.params;
                ...
                const performance = yield game_repositories_1.GameRepository.fetchGuestPerformanceInSession(sessionId, name);
